...
import com.int403.jabong.gifviewer2.bumptech.load.data.ByteArrayFetcher;
...
public class StreamByteArrayLoader implements StreamModelLoader<byte[]> {
    ...
    /**
     * @deprecated Use {@link com.int403.jabong.gifviewer2.bumptech.GenericRequestBuilder#signature(com.int403.jabong.gifviewer2.bumptech.load.Key)}
    ...
    /**
     * Factory for {@link com.int403.jabong.gifviewer2.bumptech.load.model.stream.StreamByteArrayLoader}.
     */
