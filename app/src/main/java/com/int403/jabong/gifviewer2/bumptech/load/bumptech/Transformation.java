...
public interface Transformation<T> extends Key {
   ...
   * com.int403.jabong.gifviewer2.bumptech.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *                  com.int403.jabong.gifviewer2.bumptech.request.target.Target} to indicate the
