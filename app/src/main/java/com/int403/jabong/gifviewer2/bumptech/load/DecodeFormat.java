 ...
 * returned by a {@link com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.BitmapDecoder}.
 *
 * <p>
 *     Note - In some cases it may not be possible to obey the requested setting, not all
 *     {@link com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.BitmapDecoder}s support setting formats and certain images may
...
public enum DecodeFormat {
    /**
     * All bitmaps returned by the {@link com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.BitmapDecoder} should return
