package com.int403.jabong.gifviewer2.bumptech.request.bumptech;
...
import com.int403.jabong.gifviewer2.bumptech.request.BaseRequestOptions;


/**
 * The standard concrete implementation of {@link BaseRequestOptions}.
 *
 * <p> Uses with custom types, transformations, or options can subclass and customize. {@link
 * BaseRequestOptions}. </p>
 */
...
public final class RequestOptions extends BaseRequestOptions<RequestOptions> {
  ...
  /**
   * Returns a {@link RequestOptions} object with {@link #transform(Class, Transformation)} (Context, Transformation)} set.
   */
  ...
  /**
   * Returns a {@link RequestOptions} object with the given {@link com.int403.jabong.gifviewer2.bumptech.load.bumptech.Option} set via
  ...
  /**
   * Returns a {@link RequestOptions} object with {@link #format(com.int403.jabong.gifviewer2.bumptech.load.DecodeFormat)}  set.
   */
