...
import com.int403.jabong.gifviewer2.bumptech.load.MultiTransformation;
...
import com.int403.jabong.gifviewer2.bumptech.load.resource.UnitTransformation;
...
import com.int403.jabong.gifviewer2.bumptech.provider.ChildLoadProvider;
import com.int403.jabong.gifviewer2.bumptech.provider.LoadProvider;
import com.int403.jabong.gifviewer2.bumptech.request.FutureTarget;
import com.int403.jabong.gifviewer2.bumptech.request.GenericRequest;
import com.int403.jabong.gifviewer2.bumptech.request.Request;
import com.int403.jabong.gifviewer2.bumptech.request.RequestCoordinator;
import com.int403.jabong.gifviewer2.bumptech.request.RequestFutureTarget;
import com.int403.jabong.gifviewer2.bumptech.request.RequestListener;
import com.int403.jabong.gifviewer2.bumptech.request.ThumbnailRequestCoordinator;
import com.int403.jabong.gifviewer2.bumptech.request.animation.GlideAnimationFactory;
import com.int403.jabong.gifviewer2.bumptech.request.animation.NoAnimation;
import com.int403.jabong.gifviewer2.bumptech.request.animation.ViewAnimationFactory;
import com.int403.jabong.gifviewer2.bumptech.request.animation.ViewPropertyAnimation;
import com.int403.jabong.gifviewer2.bumptech.request.animation.ViewPropertyAnimationFactory;
import com.int403.jabong.gifviewer2.bumptech.request.target.PreloadTarget;
import com.int403.jabong.gifviewer2.bumptech.request.target.SizeReadyCallback;
import com.int403.jabong.gifviewer2.bumptech.request.target.Target;
import com.int403.jabong.gifviewer2.bumptech.signature.EmptySignature;
import com.int403.jabong.gifviewer2.bumptech.util.Util;
import com.int403.jabong.gifviewer2.glide.GlideContext;
 ...
 * @param <DataType> The data type that the resource {@link com.int403.jabong.gifviewer2.bumptech.load.model.ModelLoader} will provide that
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
     ...
     *     {@link com.int403.jabong.gifviewer2.bumptech.load.model.ModelLoader}, {@link ResourceDecoder}, and
     ...
     *
     * @see com.int403.jabong.gifviewer2.bumptech.load.resource.transcode.UnitTranscoder
     * @see com.int403.jabong.gifviewer2.bumptech.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @see com.int403.jabong.gifviewer2.bumptech.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     *
     ...
     *
     * @see #animate(int)
     * @see #animate(Animation) (com.int403.jabong.gifviewer2.bumptech.request.animation.ViewPropertyAnimation.Animator)
     *
     ...
     * {@link #animate
     *(Animator)}. Scheduled to be removed in
     * Glide 4.0.
     ...
     * memory cache).
     *
     * @param animator The {@link com.int403.jabong.gifviewer2.bumptech.request.animation.ViewPropertyAnimation.Animator} to run.
     * @return This request builder.
     */
     ...
     * </p>
     *
     * @see com.int403.jabong.gifviewer2.bumptech.signature.StringSignature
     *
