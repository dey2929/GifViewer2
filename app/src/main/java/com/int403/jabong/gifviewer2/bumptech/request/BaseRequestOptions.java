...
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.bumptech.BitmapDrawableTransformation;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.bumptech.BitmapEncoder;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.bumptech.CenterInside;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.bumptech.CircleCrop;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.bumptech.DownsampleStrategy;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.bumptech.Downsampler;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.bumptech.StreamGifDecoder;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.bumptech.VideoBitmapDecoder;
...
import com.int403.jabong.gifviewer2.bumptech.load.resource.gif.bumptech.ByteBufferGifDecoder;
...
public abstract class BaseRequestOptions<CHILD extends BaseRequestOptions<CHILD>>
  ...
  private com.int403.jabong.gifviewer2.bumptech.load.Key signature = EmptySignature.obtain();
  ...
  /**
   * Applies a multiplier to the {@link com.int403.jabong.gifviewer2.bumptech.request.target.Target}'s size before
   ...
   *                       {@link com.int403.jabong.gifviewer2.bumptech.request.target.Target}'s dimensions when
   ...
   * {@link com.int403.jabong.gifviewer2.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.int403.jabong.gifviewer2.bumptech.request.target.Target}'s width and height with the
   ...
   *
   * @param context Any {@link Context}.
   * @see #optionalTransform(Context, DownsampleStrategy, Transformation) (Class, .Transformation)
   ...
   * {@link com.int403.jabong.gifviewer2.glide.TransitionOptions#dontTransition()}</p>
   */
