...
import com.int403.jabong.gifviewer2.bumptech.request.animation.DrawableCrossFadeFactory;
...
public class GifRequestBuilder<ModelType>
    ...
    /**
     * Transforms each frame of the GIF using {@link com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transformFrame(com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(com.int403.jabong.gifviewer2.bumptech.load.Transformation[])
     * @see #transform(com.int403.jabong.gifviewer2.bumptech.load.Transformation[])
     *
    ...
    /**
     * Transforms each frame of the GIF using {@link com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transformFrame(com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(com.int403.jabong.gifviewer2.bumptech.load.Transformation[])
