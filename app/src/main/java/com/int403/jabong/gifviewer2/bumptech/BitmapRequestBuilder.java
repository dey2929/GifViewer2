...
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.BitmapTransformation;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.Downsampler;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.FileDescriptorBitmapDecoder;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.ImageVideoBitmapDecoder;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.StreamBitmapDecoder;
import com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.VideoBitmapDecoder;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
    ...
    /**
     * Transform images using {@link com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
    ...
    /**
     * Transform images using {@link com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(BitmapTransformation...)
     * @see #transform(Transformation[])
