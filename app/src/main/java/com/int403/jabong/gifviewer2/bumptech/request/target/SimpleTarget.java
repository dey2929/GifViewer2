...
public abstract class SimpleTarget<Z> extends BaseTarget<Z> {
     ...
     * {@link GenericRequestBuilder#override(int, int)} on the request builder this target is given
     * to.
     *
     * <p>
     *     Requests that load into this target will throw an {@link IllegalArgumentException} if
     *     {@link GenericRequestBuilder#override(int, int)} was not called on the request builder.
     * </p>
     */
    public SimpleTarget() {
        this(-1, -1);
