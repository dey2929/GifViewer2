...
import com.int403.jabong.gifviewer2.bumptech.load.engine.DiskCacheStrategy;
import com.int403.jabong.gifviewer2.bumptech.load.model.ModelLoader;
import com.int403.jabong.gifviewer2.bumptech.load.model.file_descriptor.FileDescriptorModelLoader;
import com.int403.jabong.gifviewer2.bumptech.load.model.stream.MediaStoreStreamLoader;
import com.int403.jabong.gifviewer2.bumptech.load.model.stream.StreamByteArrayLoader;
import com.int403.jabong.gifviewer2.bumptech.load.model.stream.StreamModelLoader;
import com.int403.jabong.gifviewer2.bumptech.manager.ConnectivityMonitor;
import com.int403.jabong.gifviewer2.bumptech.manager.ConnectivityMonitorFactory;
...
import com.int403.jabong.gifviewer2.bumptech.signature.ApplicationVersionSignature;
import com.int403.jabong.gifviewer2.bumptech.signature.MediaStoreSignature;
import com.int403.jabong.gifviewer2.bumptech.signature.StringSignature;
...
public class RequestManager implements LifecycleListener {
     ...
     *     so be wary of using
     *     {@link GenericRequestBuilder#listener(com.int403.jabong.gifviewer2.bumptech.request.RequestListener )}} when
     ...
     * @see #load(Object)
     *
     * @param string A file path, or a uri or url handled by {@link com.int403.jabong.gifviewer2.bumptech.load.model.UriLoader}.
     */
     ...
     * {@link com.int403.jabong.gifviewer2.bumptech.load.model.UriLoader}.
     */
     ...
     *
     * <p>
     *  Falls back to the registered {@link com.int403.jabong.gifviewer2.bumptech.load.model.ModelLoaderFactory} registered for
    ...
    /**
     * Returns a request builder that uses the {@link com.int403.jabong.gifviewer2.bumptech.load.model.ModelLoaderFactory} currently
     * registered for {@link File} to load the image represented by the given {@link File}. Defaults to
     * {@link com.int403.jabong.gifviewer2.bumptech.load.model.stream.StreamByteArrayLoader.Factory} and
     * {@link com.int403.jabong.gifviewer2.bumptech.load.model.stream.StreamFileLoader} to load images from {@link File}s.
     *
     *  <p>
     ...
     * to {@link com.int403.jabong.gifviewer2.bumptech.load.model.stream.StreamByteArrayLoader.Factory}
     * and
     * {@link com.int403.jabong.gifviewer2.bumptech.load.model.stream.StreamResourceLoader} to load resource id models.
     *
     * <p>
     ...
     * {@link com.int403.jabong.gifviewer2.bumptech.load.model.stream.HttpUrlGlideUrlLoader} and
     * {@link com.int403.jabong.gifviewer2.bumptech.load.data.HttpUrlFetcher} to load {@link URL} models.
     *
     * @see #from(Class)
     * @see #load(URL)
     *
    ...
    /**
     * Returns a request builder that uses the {@link com.int403.jabong.gifviewer2.bumptech.load.model.ModelLoaderFactory}s currently
     ...
     * {@link com.int403.jabong.gifviewer2.bumptech.load.model.ModelLoaderFactory}s registered for the given model class for
     ...
     *     {@link DrawableRequestBuilder#into(com.int403.jabong.gifviewer2.bumptech.request.target.Target)}. You may
     ...
     *     {@link DrawableRequestBuilder#into(com.int403.jabong.gifviewer2.bumptech.request.target.Target)}}. However,
