 ...
 * {@link Context}.
 *
 * @param <T> The type of the model the {@link com.int403.jabong.gifviewer2.bumptech.load.model.ModelLoader}s built by this factory
 *           can handle
 * @param <Y> The type of data the {@link com.int403.jabong.gifviewer2.bumptech.load.model.ModelLoader}s built by this factory can load.
 */
