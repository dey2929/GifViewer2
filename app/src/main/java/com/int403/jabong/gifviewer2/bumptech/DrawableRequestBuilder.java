...
public class DrawableRequestBuilder<ModelType>
     ...
     *
     * @see #fitCenter()
     * @see #transform(com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.BitmapTransformation...)
     * @see #bitmapTransform(com.int403.jabong.gifviewer2.bumptech.load.Transformation[])
    ...
    /**
     * Transform {@link GlideDrawable}s using {@link com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(com.int403.jabong.gifviewer2.bumptech.load.resource.bitmap.BitmapTransformation...)
     * @see #bitmapTransform(com.int403.jabong.gifviewer2.bumptech.load.Transformation[])
