...
/**
 * An { com.int403.jabong.gifviewer2.bumptech.load.engine.bitmap_recycle.BitmapPool} implementation that uses an
 * { com.int403.jabong.gifviewer2.bumptech.load.engine.bitmap_recycle.LruPoolStrategy} to bucket {@link Bitmap}s and then uses an LRU
